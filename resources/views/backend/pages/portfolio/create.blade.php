<!-- Medium modal -->
<div class="modal fade" id="portfolioModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            ">
                                ...
                                <label for="md">select <input type="file" id="md" class="mdI" multiple name="file[]" {{--
                                        onchange="var img = document.getElementById('blah');img.src = window.URL.createObjectURL(this.files[0]);img.width = 100;img.height = 100"
