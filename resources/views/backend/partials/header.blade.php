            ...
            <div class="dropdown">
                <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                    <span class="user-icon">
                        <img src="{{ Auth::user()->image ?: asset('noImage.png') }}" alt="" style="width: 100%;
                        height: 100%;" />
                    </span>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                    ...
                    <a class="dropdown-item" href="{{ url('') }}"><i class="dw dw-settings2"></i> Go to website</a>
                    <a class="dropdown-item" href="faq.html"><i class="dw dw-help"></i> Help</a> --}}
                    <a class="dropdown-item" href="{{ url('') }}"><i class="dw dw-user1"></i> Go to website</a>
